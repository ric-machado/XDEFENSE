...
# PostgreSQL app (Fase 3+)
XORCISM_DB_ENGINE=postgresql
XORCISM_DB_HOST=pgbouncer
XORCISM_DB_PORT=6432
XORCISM_DB_USER=xdefense_app
XORCISM_DB_PASSWORD=${POSTGRES_APP_PASSWORD}
XORCISM_DB_NAME=xdefense
