-- PostgreSQL DDL — schema: xthreat
-- Gerado por scripts/pg_convert.sh a partir de XTHREAT_sqlite.sql
-- NÃO edite manualmente; re-execute o script para regenerar.

SET search_path = "xthreat", public;

CREATE TABLE IF NOT EXISTS "THREATACTION" (
...
CREATE TABLE IF NOT EXISTS "THREATACTIONCATEGORY" (
	"ThreatActionCategoryID" INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS "THREATACTIONFORINCIDENT" (
...
CREATE TABLE IF NOT EXISTS "THREATACTIONLOCATION" (
...
CREATE TABLE IF NOT EXISTS "THREATACTIONLOCATIONFORTHREATACTIONCATEGORY" (
	"ThreatActionCategoryLocationID" INTEGER NOT NULL,
	"ThreatActionCategoryID" INTEGER NOT NULL,
	"ThreatActionLocationID" INTEGER NOT NULL
);

CREATE TABLE IF NOT EXISTS "THREATACTIONTARGET" (
...
CREATE TABLE IF NOT EXISTS "THREATACTIONVARIETY" (
...
CREATE TABLE IF NOT EXISTS "THREATACTIONVARIETYFORTHREATACTORTTP" (
...
CREATE TABLE IF NOT EXISTS "THREATACTIONVECTOR" (
...
CREATE TABLE IF NOT EXISTS "THREATACTORADDRESS" (
...
CREATE TABLE IF NOT EXISTS "THREATACTORCHANGERECORD" (
	"ThreatActorChangeRecordID" INTEGER NOT NULL
);

CREATE TABLE IF NOT EXISTS "THREATACTOREMAILADDRESS" (
	"ThreatActorEmailAddressID" INTEGER NOT NULL
);

CREATE TABLE IF NOT EXISTS "THREATACTORFORINCIDENT" (
...
CREATE TABLE IF NOT EXISTS "THREATACTORFORTHREATCAMPAIGN" (
...
CREATE TABLE IF NOT EXISTS "THREATACTORGROUP" (
...
CREATE TABLE IF NOT EXISTS "THREATACTORGROUPTACTIC" (
...
CREATE TABLE IF NOT EXISTS "THREATACTORINFRASTRUCTURE" (
...
CREATE TABLE IF NOT EXISTS "THREATACTORINFRASTRUCTUREFORTHREATACTOR" (
...
CREATE TABLE IF NOT EXISTS "THREATACTORINFRASTRUCTUREFORTHREATACTORTTP" (
...
CREATE TABLE IF NOT EXISTS "THREATACTORPAOS" (
...
CREATE TABLE IF NOT EXISTS "THREATACTORROLE" (
...
CREATE TABLE IF NOT EXISTS "THREATACTORSKILLFORATTACKPATTERN" (
...
CREATE TABLE IF NOT EXISTS "THREATACTORSOPHISTICATION" (
...
CREATE TABLE IF NOT EXISTS "THREATACTORTACTIC" (
	"ThreatActorTacticID" INTEGER NOT NULL,
	"TacticID" INTEGER NULL
);

CREATE TABLE IF NOT EXISTS "THREATACTORTAG" (
	"ThreatActorTagID" INTEGER NOT NULL
);

CREATE TABLE IF NOT EXISTS "THREATACTORTTP" (
	"ThreatActorTTPID" INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS "THREATACTORTTPFORINCIDENT" (
...
CREATE TABLE IF NOT EXISTS "THREATACTORTTPFORINDICATOR" (
...
CREATE TABLE IF NOT EXISTS "THREATACTORTTPFORTHREATACTORTTP" (
...
CREATE TABLE IF NOT EXISTS "THREATACTORVARIETY" (
...
CREATE TABLE IF NOT EXISTS "THREATAGENT" (
...
CREATE TABLE IF NOT EXISTS "THREATAGENTCATEGORY" (
	"ThreatAgentCategoryID" INTEGER NOT NULL,
	"CategoryID" INTEGER NULL
);

CREATE TABLE IF NOT EXISTS "THREATAGENTCHANGERECORD" (
	"ThreatAgentChangeRecordID" INTEGER NOT NULL
);

CREATE TABLE IF NOT EXISTS "THREATAGENTFOROWASPTOP10" (
...
CREATE TABLE IF NOT EXISTS "THREATAGENTTAG" (
...
CREATE TABLE IF NOT EXISTS "THREATCAMPAIGN" (
	"ThreatCampaignID" INTEGER NOT NULL,
	"ThreatCampaignGUID" TEXT NULL,
...
CREATE TABLE IF NOT EXISTS "THREATCAMPAIGNCHANGERECORD" (
	"ThreatCampaignChangeRecordID" INTEGER NOT NULL
);

CREATE TABLE IF NOT EXISTS "THREATCAMPAIGNDESCRIPTION" (
...
CREATE TABLE IF NOT EXISTS "THREATCAMPAIGNFORTHREATCAMPAIGN" (
...
CREATE TABLE IF NOT EXISTS "THREATCAMPAIGNMETHODOLOGY" (
	"ThreatCampaignMethodologyID" INTEGER NOT NULL
);

CREATE TABLE IF NOT EXISTS "THREATCAMPAIGNNAME" (
...
CREATE TABLE IF NOT EXISTS "THREATCAMPAIGNNAMEFORTHREATCAMPAIGN" (
...
CREATE TABLE IF NOT EXISTS "THREATCAMPAIGNREFERENCE" (
...
CREATE TABLE IF NOT EXISTS "THREATCAMPAIGNSOURCE" (
	"ThreatCampaignSourceID" INTEGER NOT NULL
);

CREATE TABLE IF NOT EXISTS "THREATCAMPAIGNSTATUS" (
...
CREATE TABLE IF NOT EXISTS "THREATCAMPAIGNTAG" (
...
CREATE TABLE IF NOT EXISTS "THREATCAMPAIGNTECHNIQUE" (
	"ThreatCampaignTechniqueID" INTEGER NOT NULL
);

CREATE TABLE IF NOT EXISTS "THREATCAMPAIGNTOOL" (
	"ThreatCampaignToolID" INTEGER NOT NULL
);

CREATE TABLE IF NOT EXISTS "THREATCAMPAIGNTYPE" (
...
CREATE TABLE IF NOT EXISTS "THREATCATEGORY" (
...
CREATE TABLE IF NOT EXISTS "THREATCATEGORYDESCRIPTION" (
...
CREATE TABLE IF NOT EXISTS "THREATCATEGORYREFERENCE" (
...
CREATE TABLE IF NOT EXISTS "THREATCATEGORYTAG" (
...
CREATE TABLE IF NOT EXISTS "THREATINTENDEDEFFECT" (
...
CREATE TABLE IF NOT EXISTS "THREATINTENDEDEFFECTFORINCIDENT" (
...
CREATE TABLE IF NOT EXISTS "THREATINTENDEDEFFECTFORTHREATACTORTTP" (
...
CREATE TABLE IF NOT EXISTS "THREATINTENDEDEFFECTFORTHREATCAMPAIGN" (
...
CREATE TABLE IF NOT EXISTS "THREATMOTIVE" (
...
CREATE TABLE IF NOT EXISTS "THREATMOTIVEDESCRIPTION" (
	"ThreatMotiveDescriptionID" INTEGER NOT NULL
);

CREATE TABLE IF NOT EXISTS "THREATMOTIVEFORTHREATACTOR" (
...
CREATE TABLE IF NOT EXISTS "THREATMOTIVETAG" (
	"ThreatMotiveTagID" INTEGER NOT NULL
);

CREATE TABLE IF NOT EXISTS "THREATTYPE" (
...
CREATE TABLE IF NOT EXISTS "THREATTYPEDESCRIPTION" (
...
CREATE TABLE IF NOT EXISTS LLMATTACKTECHNIQUE (
        ...
        ActorCount INTEGER, PrevalencePct DOUBLE PRECISION, AriesMean DOUBLE PRECISION,
